...
idx_train, y_train, idx_valid, y_valid, idx_test, y_test = getXVY(image_labels, 0.5, 0.25, 0.25)
...
filename = 'densenet_502525.csv'
filename_tst = 'densenet_502525_tst.csv'
png_name_acc = 'densenet_502525_accuracy.png'
png_name_loss = 'densenet_502525_loss.png'
